...
class GameVersionTests(unittest.TestCase):
    ...
    def test_central_version_api(self):
        ...
        self.assertEqual(get_game_version(), "0.1.2")
        self.assertEqual(get_game_version_tuple(), (0, 1, 2))
        self.assertEqual(get_version_display(), "Alpha v0.1.2")
        self.assertEqual(get_full_version_display(), "FarmGame Alpha v0.1.2")
